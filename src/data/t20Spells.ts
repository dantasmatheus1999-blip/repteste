...
export const T20_SPELLS: T20Spell[] = [
  {
  ...
  },
  {
    ...
    aprimoramentos: [
      ...
      '+1 PM: muda o alvo para 1 monstro ou espírito com Inteligência –5 ou –4.',
  ...
  },
  {
    ...
    aprimoramentos: [
      ...
      '+2 PM: a arma causa +1d6 de dano de ácido, eletricidade, fogo ou frio, escolhido quando a magia é lançada. Este aprimoramento só pode ser usado uma vez.',
      '+3 PM: muda o bônus de dano do aprimoramento acima para +2d6.'
    ]
  },
  {
    id: 'armadura-arcana',
  ...
  },
  {
    ...
    aprimoramentos: [
      ...
      '+2 PM: o monstro ganha redução 5 contra dois tipos de dano (por exemplo, corte e frio).',
  ...
  },
  {
    ...
    duration: '4d12 horas',
    description: 'Você muda o clima da área onde se encontra, podendo criar qualquer condição climática: chuva, neve, ventos, névoas... Veja o Capítulo 6: O Mestre para os efeitos do clima.',
    aprimoramentos: [
  ...
  },
  {
    ...
    duration: 'instantânea',
    description: 'Você invoca um objeto de qualquer lugar para sua mão. O item deve ter sido previamente preparado com uma runa pessoal sua (ao custo de T$ 5). A magia não funciona se o objeto estiver com outra criatura, mas você saberá onde ele está e quem o está carregando (ou sua descrição física, caso não conheça a criatura).',
    aprimoramentos: [
  ...
  },
  {
    ...
    aprimoramentos: [
      '+1 PM: aumenta la quantidade do elemento em um passo (uma categoria de tamanho para água ou terra, +1 quadrado de 1,5m para ar e fogo).',
  ...
  },
  {
    ...
    aprimoramentos: [
      ...
      '+2 PM: também remove uma condição de cansaço do alvo.',
  ...
  },
  {
    ...
    aprimoramentos: [
      ...
      '+5 PM: muda o alcance para pessoal e o alvo para área: esfera com 6m de raio. Todas as criaturas e objetos mundanos na área são afetados.'
    ]
  },
  {
  ...
  },
  {
    ...
    aprimoramentos: [
      ...
      '+2 PM: muda o efeito para fornecer camuflagem total por escuridão total. O alvo emana escuridão total e ela bloqueia a visão na área e através dela.',
  ...
  },
  {
    ...
    aprimoramentos: [
      '+1 PM: além do normal , o alvo fica fraco pela cena (passar no teste de resistência evita).',
      '+2 PM: aumenta o dano em +1d8+1.',
  ...
  },
  {
    ...
    aprimoramentos: [
      ...
      '+5 PM: muda o alvo para até 5 criaturas.',
  ...
  },
  {
    ...
    aprimoramentos: [
      '+4 PM: muda o alcance para toque e o alvo para 1 criatura voluntária. Requer 4º círculo.'
    ]
  },
  {
    id: 'manto-do-cruzado',
  ...
  },
  {
    ...
    execution: 'padrão',
    range: 'toque',
    target: 'superfície ou objeto plano, como uma mesa ou papel',
    duration: 'cena',
  ...
  },
  {
    ...
    description: 'O alvo cai lentamente. A velocidade da queda é reduzida para 18m por rodada — o suficiente para não causar dano. Como lançar esta magia é uma reação, você pode lançá-la rápido o bastante para salvar a si ou um aliado de quedas inesperadas. Lançada sobre um projétil — como uma flecha ou uma rocha largada do alto de um penhasco —, a magia faz com que ele cause metade do dano normal, devido à lentidão.\n\nQueda Suave só funciona em criaturas e objetos em queda livre; a magia não vai frear um golpe de espada ou o mergulho rasante de um atacante voador.',
  ...
  },
  {
    ...
    aprimoramentos: [
      '+2 PM: aumenta o dano em +2d6.',
      '+3 PM: muda o alcance para médio e a área para alvo: criaturas escolhidas. Em vez do normal, você dispara vários relâmpagos, um para cada alvo escolhido, causando 6d6 pontos de dano de eletricidade. Requer 3º círculo.'
    ]
  },
  {
  ...
  },
  {
    ...
    aprimoramentos: [
      '+5 PM: o objeto que abriga a alma detém os mesmos PM totais que o alvo. Se estiver empunhando o objeto, você pode usar esses PM para pagar o custo de PM para lançar magias. O objeto recupera PM por dia como se o personagem estivesse em descanso normal.',
  ...
  },
  {
    ...
    aprimoramentos: [
      ...
      '+9 PM: também protege o alvo contra efeitos de área. Uma criatura que tente atacar uma área que inclua o alvo deve fazer the teste de Vontade; se falhar, não consegue e perde a ação. Ela só pode tentar novamente se o alvo sair da área.'
    ]
  },
  {
    id: 'segunda-chance',
  ...
  },
  {
    ...
    target: 'você',
    duration: 'sustentada',
    description: 'Você se torna uma máquina de combate, ficando mais forte, rápido e resistente. Você recebe +6 na Defesa, testes de ataque e rolagens de dano corpo\na corpo, e 30 PV temporários. Durante\na Transformação de Guerra você não pode\nlançar magias, mas se torna proficiente\nem todas as armas.',
    aprimoramentos: [
  ...
  },
  {
    ...
    target: 'você',
    duration: 'instantânea',
    description: 'Você suga energia vital da terra, recebendo 2d10 pontos de vida temporários. Os PV temporários desaparecem\nao final da cena.',
    aprimoramentos: [
