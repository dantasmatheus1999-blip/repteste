...
export const JoinGameFlowModal: React.FC<JoinGameFlowModalProps> = ({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-3 sm:p-4 bg-black/80 backdrop-blur-sm animate-in fade-in duration-200">
      <div 
        className="w-full max-w-lg rounded-2xl border border-amber-800/60 bg-gradient-to-b from-[#1b1510] via-[#14100c] to-[#0c0907] p-5 sm:p-7 shadow-[0_25px_65px_rgba(0,0,0,0.95)] relative overflow-hidden flex flex-col max-h-[92vh]"
        style={{
          ...
          <div className="space-y-4 pt-1">
            ...
            <div className="space-y-2 pt-2">
              ...
              <button
                ...
                onClick={() => setStep(2)}
                disabled={isSubmitting}
                className="w-full py-2.5 text-xs font-cinzel font-semibold uppercase tracking-wider text-stone-400 hover:text-stone-200 transition-colors cursor-pointer"
              >
