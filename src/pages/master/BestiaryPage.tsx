  ...
  const handleSaveMonster = async (monster: GeneratedMonster) => {
    ...
    try {
      const monsterData: Partial<NPC> = {
        ...
        realmorScale: monster.realmorScale,
        rank: monster.rank,
        nd: monster.nd,
        theme: monster.theme,
        ...
        bossResources: monster.bossResources || [],
        specialActions: monster.specialActions || [],
        manaPoints: monster.manaPoints ?? (monster.spells && monster.spells.length > 0 ? 3 : 0),
        saveDC: monster.saveDC,
        fortitude: monster.fortitude,
        reflexes: monster.reflexes,
        will: monster.will,
        targetDamage: monster.targetDamage,
        tableReference: monster.tableReference,
        auditLog: monster.auditLog,
        validation: monster.validation,
        stats: {
          hp: monster.hp,
          mp: monster.manaPoints ?? 0,
          ac: monster.defense,
